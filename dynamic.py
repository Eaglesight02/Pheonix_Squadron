...
# decoded_Image = base64.b64decode(path)
    ...
    return templates.TemplateResponse("index.html", {"request": request, "img": image, "img_Path": shape, "probability": prediction, "patient_Name":patient_Name,"patient_Age":patient_Age,"patient_Email":patient_Email,"Gender":Gender})
